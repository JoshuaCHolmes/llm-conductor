...
use super::{InstallStatus, ModelManager, OllamaInstaller};
...
impl FirstRunSetup {
    ...
    pub async fn run(&mut self) -> Result<()> {
        ...
        println!(
            "{}",
            "║  Welcome to llm-conductor! 🎭        ║".bright_cyan()
        );
        println!(
            "{}",
            "╚═══════════════════════════════════════╝".bright_cyan()
            ...
            .interact()?
        {
            ...
            println!(
                "{}",
                "Skipped. You can configure later with: llm-conductor config user".yellow()
            );
        }
        ...
        println!(
            ...
            "API Credentials (Optional)".bright_white()
        );
        println!(
            "{}",
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━".bright_blue()
        ...
        println!(
            "  • {}: GLM-5 Plus (89B parameters)",
            "NVIDIA NIM".bright_white()
        );
        println!(
            "  • {}: GPT-4o, Claude Sonnet",
            "GitHub Copilot".bright_white()
        );
            ...
            .interact()?
        {
            ...
            println!(
                "{}",
                "Skipped. You can add keys later with: llm-conductor config add-key".yellow()
            );
        }
        ...
        println!(
            ...
            "llm-conductor providers".bright_white()
        );
        println!(
            "  {} - View configuration",
            "llm-conductor config show".bright_white()
        );
        println!();
    ...
    fn show_manual_install_options() {
        ...
        println!(
            "{}",
            "═══ Alternative Installation Methods ═══".bright_yellow()
        );
        println!();
        println!(
            "{}",
            "Option 1: Docker (Works on all platforms)".bright_cyan()
        );
        ...
        println!(
            "  Website: {}",
            "https://ollama.com/download".bright_white()
        );
        println!();
        ...
        println!(
            "{}",
            "After installation, run: llm-conductor setup".bright_green()
        );
    }
